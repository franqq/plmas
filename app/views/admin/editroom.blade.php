									...
									<div class="border-left maxheight">
										<div class="left-top-corner maxheight">
											<div class="right-top-corner maxheight">
												<div class="inner">
												<hc style="text-transform:capitalize;"><span>Edit Room</span>	
												</hc>
													<div class="post">
													<form name="post-form"  id="postf-form" enctype="multipart/form-data" method="post" action="{{URL::route('admin-edit-room-post')}}" >
														...
														<div class="field">
																...
																<input required="required" value="{{$name}}" name="Name" type="text">
																@if($errors->has('Name'))
														...
														<div class="field">
																...
																<input required="required" value="{{$capacity}}" name="Capacity" type="text">
														...
														<div class="field">
															...
															{{Form::token()}}
															<label2><strong>&nbsp;</strong></label2><input  type="submit" value="Update"/>
														</div>
