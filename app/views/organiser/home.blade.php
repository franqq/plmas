									...
									<div class="border-left maxheight">
										<div class="left-top-corner maxheight">
											<div class="right-top-corner maxheight">
												<div class="inner">
												<hc style="text-transform:capitalize;"><span>My Events</span>	
												</hc>
												...
												<ul class="mysqueeb">
														...
														<div class="news-feed">
															<li>
																<a href="{{URL::route('organiser-event-get',$event->id)}}">
																	<mainimg>
																		{{HTML::image(isset($event->Photo()->first()->path) ? $event->Photo()->first()->path : 'pics/default.png',$event->title)}} 
																	</mainimg>
																</a>
																<stime>8h.</stime>
																<strong><a href="{{URL::route('organiser-event-get',$event->id)}}">{{$event->title}}
																{{HTML::image('images/event.png')}}
																</a>
																</strong>
																
																<psquib>
																{{$event->overview}}<a href="{{URL::route('organiser-event-get',$event->id)}}"> ...see more</a>
																</psquib>
																@include('organiser.layouts.other_share')
															</li>
														</div>
														@endforeach
